...
/**
 * StreamPark 封装 Flink Java DataStream Kafka Source
 *
 * @param <T>
 */
public class KafkaJavaSource<T> {
    ...
    /**
     * StreamPark 封装了 Flink DataStream 执行上下文 也即 StreamingContext
     *
     * @param context
     */
