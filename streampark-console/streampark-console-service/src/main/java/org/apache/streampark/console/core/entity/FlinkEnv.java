...
public class FlinkEnv implements Serializable {
    ...
    public void doSetVersion() {
        // 通过执行 java -classpath lib/flink-dist-1.16.0.jar org.apache.flink.client.cli.CliFrontend --version
        // 命令查询 flink 版本 比如 1.16.0
        this.setVersion(this.getFlinkVersion().version());
        // 通过规则匹配 ${FLINK_HOME}/lib/flink-dist*.jar 获取 scala 版本
        // 否则默认 2.12 (1.15.0+ 以上)
