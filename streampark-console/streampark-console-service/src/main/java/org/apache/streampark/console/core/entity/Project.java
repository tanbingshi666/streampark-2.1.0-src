...
public class Project implements Serializable {
    ...
    public File getAppSource() {
         ...
         * 创建从远程仓库拉取代码目录
         * 格式：
         * ${STREAMPARK_HOME}/workspace/project/${project_name}/${代码仓库名称}-${branch}
         * 比如：
         * /opt/app/streampark/streampark-2.1.0/workspace/project/streampark-example/flink-1.16.0-code-master
         */
        if (appSource == null) {
